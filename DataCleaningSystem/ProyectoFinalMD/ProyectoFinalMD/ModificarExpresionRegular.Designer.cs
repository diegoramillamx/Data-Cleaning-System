...
{
	partial class ModificarExpresionRegular
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.groupBox1.Text = "Modificar expresión regular";
			// 
			// txtValorNuevo
			// 
			...
			this.cboNombreAtributos.SelectedIndexChanged += new System.EventHandler(this.CboNombreAtributosSelectedIndexChanged);
			// 
			// btnAceptar
			// 
			this.btnAceptar.Location = new System.Drawing.Point(155, 163);
			...
			// txtViejoValor
			// 
			this.txtViejoValor.Enabled = false;
			...
			// 
			// ModificarExpresionRegular
			// 
			this.AutoScaleDimensions = new System.Drawing.SizeF(8F, 16F);
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			this.ClientSize = new System.Drawing.Size(537, 260);
			this.Controls.Add(this.groupBox1);
			this.Name = "ModificarExpresionRegular";
			this.Text = "ModificarExpresionRegular";
